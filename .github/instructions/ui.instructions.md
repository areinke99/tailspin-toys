...
- **Document component APIs with TypeScript types and JSDoc comments** describing what each prop does (see [`comments-and-docs.instructions.md`](comments-and-docs.instructions.md))
